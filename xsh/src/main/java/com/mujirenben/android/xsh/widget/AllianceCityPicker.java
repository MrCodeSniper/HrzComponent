 ...
 */
public class AllianceCityPicker implements CanShow, OnWheelChangedListener {
    ...
    public interface OnCityItemClickListener {
        ...
        void onCancel();
        void onChoose(Integer industryId, String industryName);
    }
    ...
    private AllianceCityPicker(Builder builder) {
        ...
        mTvOK.setOnClickListener(v -> {
            if (showProvinceAndCity) {
                ...
                listener.onChoose(mCurrentIndustryId,mCurrentCityName);
            } else {
    ...
    public static class Builder {
        ...
        public Builder setAllDatas(AddressBean addressBean) {
        ...
        public AllianceCityPicker build() {
            AllianceCityPicker cityPicker = new AllianceCityPicker(this);
            return cityPicker;
        }
    ...
    private void setUpData() {
        ...
        if (!TextUtils.isEmpty(defaultProvinceName) && mProvinceDatas.length > 0) {
            ...
            for (int i = 0; i < mProvinceDatas.length; i++) {
                if (mProvinceDatas[i].contains(defaultProvinceName)) {//mProvinceDatas[i]
                    provinceDefault = i;
                    break;
                }
            }
    ...
    protected void initProvinceDatas(AddressBean addressBean) {

        List<AddressBean.ProvinceTag> provinceList = addressBean.getData();
            ...
            if (provinceList != null && provinceList.size()>0) {
                ...
                List<AddressBean.ProvinceTag.CitysTag> cityList = provinceList.get(0).getCitys();
...
//            Logger.e(provinceList.toString());
            for (int i = 0; i < provinceList.size(); i++) {
                // 遍历所有省的数据

                mProvinceDatas[i] = provinceList.get(i).getProvince();
                List<AddressBean.ProvinceTag.CitysTag> cityList = provinceList.get(i).getCitys();
                ...
                mIndustryIdMap.put(provinceList.get(i).getProvince(),industryIds);
            }
