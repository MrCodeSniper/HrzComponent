...
public class JCVideoPlayerStandard extends JCVideoPlayer {
    ...
    public boolean setUp(String url, Object... objects) {
        ...
        if (super.setUp(url, objects)) {
            ...
            Log.i(Constants.TAG,"mIfCurrentIsFullscreen"+mIfCurrentIsFullscreen);
            if (mIfCurrentIsFullscreen) {
                fullscreenButton.setImageResource(R.drawable.jc_shrink);
                iv_video_icon.setVisibility(VISIBLE);
                backButton.setVisibility(View.VISIBLE);
                backButton.setOnClickListener(this);
            } else {
                fullscreenButton.setImageResource(R.drawable.jc_enlarge);
                iv_video_icon.setVisibility(GONE);
...
//                        int progress = mSeekTimePosition * 100 / (duration == 0 ? 1 : duration);
                        int progress = mSeekTimePosition * 100 /duration;
