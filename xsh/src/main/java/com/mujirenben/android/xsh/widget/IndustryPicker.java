 ...
 */
public class IndustryPicker implements CanShow, OnWheelChangedListener {
    ...
    protected Map<String, Integer[]> mIndustryIdMap = new HashMap<String, Integer[]>();
    ...
    protected Integer mCurrentIndustryId;
    ...
    public interface OnCityItemClickListener {
        ...
        void onCancel();
        void onChoose(Integer industryId, String industryName, String fatherIndustry);
    }
    ...
    private IndustryPicker(Builder builder) {
        ...
        this.industryBean=builder.industryBean;
        ...
        //初始化城市数据
        initProvinceDatas(industryBean);
        ...
        mTvOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (showProvinceAndCity) {
                    ...
                    listener.onChoose(mCurrentIndustryId,mCurrentCityName,mCurrentProviceName);
                } else {
    ...
    public static class Builder {
        ...
        public Builder setAllDatas(IndustryBean industryBean) {
        ...
        public IndustryPicker build() {
            IndustryPicker cityPicker = new IndustryPicker(this);
            return cityPicker;
        }
    ...
    protected void initProvinceDatas(IndustryBean industryBean) {
        List<IndustryBean.DataBean> provinceList = industryBean.getData();
...
//            provinceList = handler.getDataList();
            ...
            if (provinceList != null && !provinceList.isEmpty()) {
                ...
                List<IndustryBean.DataBean.SonsBean> cityList = provinceList.get(0).getSons();
                if (cityList != null && !cityList.isEmpty()) {
                    mCurrentCityName = cityList.get(0).getName();
                    mCurrentIndustryId=cityList.get(0).getId();
...
//                    mCurrentZipCode = districtList.get(0).getZipcode();
            ...
            for (int i = 0; i < provinceList.size(); i++) {
                ...
                List<IndustryBean.DataBean.SonsBean> cityList = provinceList.get(i).getSons();
                String[] cityNames = new String[cityList.size()];
                Integer[] industryIds=new Integer[cityList.size()];
                for (int j = 0; j < cityList.size(); j++) {
                    // 遍历省下面的所有市的数据
                    cityNames[j] = cityList.get(j).getName();
                    industryIds[j]=cityList.get(j).getId();
...
//                    mDistrictDatasMap.put(cityNames[j], distrinctNameArray);
                ...
                mIndustryIdMap.put(provinceList.get(i).getName(),industryIds);
            }
        } catch (Throwable e) {
            e.printStackTrace();
        } finally {
    ...
    private void updateAreas() {
        ...
        mCurrentIndustryId=mIndustryIdMap.get(mCurrentProviceName)[pCurrent];
        if(!EmptyUtils.isEmpty(mCitisDatasMap.get(mCurrentProviceName)[pCurrent])){
