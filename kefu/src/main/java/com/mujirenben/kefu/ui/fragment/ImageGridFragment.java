...
import com.mujirenben.kefu.bean.VideoEntity;
import com.mujirenben.kefu.ui.activity.RecorderVideoActivity;
import com.mujirenben.kefu.util.ImageCache;
import com.mujirenben.kefu.util.ImageResizer;
import com.mujirenben.kefu.util.Utils;
import com.mujirenben.kefu.widget.RecyclingImageView;
	...
	public void onItemClick(AdapterView<?> parent, View v, final int position, long id) {
		...
		if(position==0)
		{
			...
			if (vEntty.size > 1024 * 1024 * 10) {
				...
				ArmsUtils.makeText(getActivity(), st);
				return;
			}
