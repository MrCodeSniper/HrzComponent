...
public class FansAndCrownUpgradePresenter
        extends BasePresenter<FansAndCrownUpgradeContract.Model, FansAndCrownUpgradeContract.View> {

    @Inject
    public FansAndCrownUpgradePresenter(FansAndCrownUpgradeContract.Model model,
                                        FansAndCrownUpgradeContract.View view) {
        super(model, view);
    }
