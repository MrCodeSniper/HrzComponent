 ...
 */
public class JDHeadersView extends PtrFrameLayout implements PtrUIHandler {
    ...
    public JDHeadersView(Context context) {
        super(context);
        initView();
    }

    public JDHeadersView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public JDHeadersView(Context context, AttributeSet attrs, int defStyle) {
