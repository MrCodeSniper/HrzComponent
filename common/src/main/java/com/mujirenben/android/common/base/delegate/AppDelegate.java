...
import com.mujirenben.android.common.base.interal.ManifestParser;
import com.mujirenben.android.common.dagger.component.AppComponent;
import com.mujirenben.android.common.dagger.component.DaggerAppComponent;
...
public class AppDelegate implements App, AppLifecycles {
    ...
    public void onCreate(@NonNull Application application) {
        ...
        LogUtil.e("hrz_process", "process name: " + prorcessName);

        if (BaseApplication.PROCESS_HRZ_MAIN.equals(prorcessName)) {
            LogUtil.e("hrz_process", "init main process");
