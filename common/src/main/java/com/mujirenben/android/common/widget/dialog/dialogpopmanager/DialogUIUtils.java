package com.mujirenben.android.common.widget.dialog.dialogpopmanager;
...
import com.mujirenben.android.common.widget.dialog.dialogpopmanager.callback.DialogAssigner;
...
import com.mujirenben.android.common.widget.dialog.dialogpopmanager.callback.TdataListener;
import com.mujirenben.android.common.widget.dialog.dialogpopmanager.utils.ToolUtils;
import com.mujirenben.android.common.widget.dialog.dialogpopmanager.widget.PopuWindowView;
...
public class DialogUIUtils {
     ...
     * @return
     */
    public static BuildBean showCustomAlert(Context context, View contentView,int showTime,String dialogName) {
        return showCustomAlert(context, contentView, Gravity.CENTER, true, true,showTime,dialogName);
    }
     ...
     * @return
     */
    public static BuildBean showCustomAlert(Context context, View contentView, int gravity,int showTime,String dialogName) {
        return showCustomAlert(context, contentView, gravity, true, true,showTime,dialogName);
    }
     ...
     * @return
     */
    public static BuildBean showCustomAlert(Context context, View contentView, int gravity, boolean cancleable, boolean outsideTouchable,int showTime,String dialogName) {
        return DialogAssigner.getInstance().assignCustomAlert(context, contentView, gravity, cancleable, outsideTouchable,showTime,dialogName,null,0L,-1);
    }

    public static BuildBean showCustomAlert(Context context, View contentView, int gravity, boolean cancleable, boolean outsideTouchable, int showTime, String dialogName, OutSideDismissListener dialogDisMissListener) {
        return DialogAssigner.getInstance().assignCustomAlert(context, contentView, gravity, cancleable, outsideTouchable,showTime,dialogName,dialogDisMissListener,0L,-2);
    }

    public static BuildBean showCustomAlert(Context context, View contentView, int gravity, boolean cancleable, boolean outsideTouchable, int showTime, String dialogName, OutSideDismissListener dialogDisMissListener,long showDate,int dialogId) {
        return DialogAssigner.getInstance().assignCustomAlert(context, contentView, gravity, cancleable, outsideTouchable,showTime,dialogName,dialogDisMissListener,showDate,dialogId);
    }
     ...
     * @return
     */
    public static BuildBean showTaoKouLingDialog(Context context,View contentView){
        return DialogAssigner.getInstance().assignTaokoulingDialog(context, contentView);
    }
     ...
     * @return
     */
    public static BuildBean showKoulingErrorDialog(Context context,View contentView){
        return DialogAssigner.getInstance().assignKouLingErrorDialog(context,contentView);
    }
     ...
     * @return
     */
     public static BuildBean showExpirationDialog(Context context,View contentView,int days){
         return DialogAssigner.getInstance().assignExpirationDialog(context,contentView,days);
     }
     ...
     * @return
     */
    public static BuildBean showDownloadDialog(Context context, boolean cancleable, boolean outsideTouchable){
        return DialogAssigner.getInstance().assignDownloadDialog(context, cancleable, outsideTouchable);
    }
     ...
     * @return
     */
   public static BuildBean showTokenOutTimeDialog(Context context,DoubleChooseListener listener){
       return DialogAssigner.getInstance().assignTokenDialog(context, listener);
   }
