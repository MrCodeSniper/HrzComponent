 ...
 * 确认 取消 Dialog
 */
public class ChooseDialog extends RxDialog {
    ...
    public ChooseDialog(Context context, float alpha, int gravity) {
    ...
    private void initView() {
        ...
        mTvSure = (TextView) dialogView.findViewById(R.id.tv_confirm);
