...
public class CustomPopupWindow extends PopupWindow {
    ...
    private Drawable mBackgroundDrawable = new BitmapDrawable();
...
//        mContentView.setOnClickListener(v -> CustomPopupWindow.this.dismiss());
    }
    ...
    public interface CustomPopupWindowListener {
        public void initPopupView(View contentView, CustomPopupWindow popupWindow);
    }
