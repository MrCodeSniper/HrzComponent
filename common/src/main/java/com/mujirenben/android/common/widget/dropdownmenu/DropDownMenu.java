package com.mujirenben.android.common.widget.dropdownmenu;
...
public class DropDownMenu extends LinearLayout {
    ...
    private onDropMenuDismissListener onDropMenuDismissListener;

    public void setOnDropMenuDismissListener(com.mujirenben.android.common.widget.dropdownmenu.onDropMenuDismissListener onDropMenuDismissListener) {
        this.onDropMenuDismissListener = onDropMenuDismissListener;
    }
    ...
    public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        tabMenuView.setVisibility(View.GONE); // 菜单不可见
    ...
    public void closeMenu() {
        ...
        if(onDropMenuDismissListener!=null){
            onDropMenuDismissListener.onDismiss();
        }
        ...
        if (current_tab_position != -1) {
            ...
            popupMenuViews.setAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.dropdown_menu_out));
            maskView.setVisibility(GONE);
            ...
            if (target == tabMenuView.getChildAt(i)) {
                if (current_tab_position == i) {
                    ...
                    if (current_tab_position == -1) {
                        ...
                        popupMenuViews.setAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.dropdown_menu_in));
